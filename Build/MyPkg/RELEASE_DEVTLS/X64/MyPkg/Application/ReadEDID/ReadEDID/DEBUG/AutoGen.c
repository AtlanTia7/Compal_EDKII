...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x10C75C00, 0x3052, 0x4467, {0x9E, 0xD8, 0x71, 0x96, 0xCA, 0xAF, 0x61, 0x0F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ReadEDID";
...
{
  return GetEDIDInfo (ImageHandle, SystemTable);
}
